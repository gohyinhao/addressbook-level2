...
== Listing all persons in sorted order : `sortedlist`

Shows a sorted list of all persons, along with their non-private details, in the address book.
The list is sorted by name alphabetically. +
Format: `sortedlist`
